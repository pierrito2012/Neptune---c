...
syn keyword neptuneControl if else while for end do return include Include define
syn keyword neptuneFunction efunc echo cin type length add remove clear upper lower contains replace substring read write append exists delete
